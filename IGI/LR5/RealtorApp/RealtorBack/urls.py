...
from . import views
from users.views import register, profile, profileedit, profiledelete, cart, cartItemDelete, cartPaid
...
urlpatterns = [
    ...
    path('cartItemDelete', cartItemDelete, name='cartItemDelete'),
    path('cartPaid', cartPaid, name='cartPaid'),
